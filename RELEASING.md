...
| 项 | 值 |
|----|-----|
| **工作树 / registry `latest`** | **`spec-wave@3.0.0`**（**已完成** · 2026-09-18 · 人执行 publish · **tag `v3.0.0`** ↔ `895b975` · dist-tags `latest=3.0.0` · `time.3.0.0`=2026-09-18T00:17:55Z · CI main `35290167676` / tag `35290167788` 双 success · 打 tag 后 17 落点 **17/17** · 发布前探针 6 项见 [`docs/harness/reviews/w7_release_probe_3_0_0_20260917.md`](docs/harness/reviews/w7_release_probe_3_0_0_20260917.md)） |
