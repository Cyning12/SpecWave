...
详见 [`docs/roadmap/PLAN_post_1.11_zh.md`](../roadmap/PLAN_post_1.11_zh.md)：

- **1.12.0**：1.x 收口（EOS/deprecate · CI 稳 · 本体论浅落地 · F6 预备清单）
- **2.0.0**：F6 宿主适配表（DSH = 首个宿主）

> 演进纪律：**2.0 引入适配表之前，1.x 内部一致性须先完成**——已于 1.11.0 达成；跨宿主不得把分裂真值源复制到 N 个宿主。
