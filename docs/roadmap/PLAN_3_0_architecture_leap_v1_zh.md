...
> ✅ **口径补正（W7 复核 · 2026-09-17）**：`CHANGELOG.md` 的 2.4.2「发布状态」已由 `1067f32`（2026-09-15 发布回填）修正为 **已 published** · tag `v2.4.2` 已落位且已推远端。**不改 2.4.2 提交本身 / 不移动 tag**（tag ≠ HEAD 纪律 · 硬约束 7）；W7 只做零残留确认并在提交说明注明「补正 2.4.2 口径滞后」。
> 2.4.1 验收归档：[`ACCEPTANCE_2_4_1_patch_2_4_1_zh.md`](./ACCEPTANCE_2_4_1_patch_2_4_1_zh.md)
> **范围主源**：① [`路线研究-SpecWave-2.2-3.0.md`](../harness/reviews/w7_evidence_route_research_2_2_to_3_0_20260917.md) §5「3.0.0 · 架构跃迁」+ §4 条目全表（加权评分与证据）；② [`.workbuddy/output/验收报告-SpecWave-2.4.0.md`](../harness/reviews/w7_evidence_acceptance_2_4_0_20260917.md) §6.2「建议并入 3.0.0」；③ [`.workbuddy/output/验收报告-SpecWave-2.4.1.md`](../harness/reviews/w7_evidence_acceptance_2_4_1_20260917.md) §4/§6.2 残余；④ [`assets/harness/discipline-coverage.yaml`](../../assets/harness/discipline-coverage.yaml) `deferred` / `not_wired` 项
> ✅ **W7 已清偿（硬约束 14 · 2026-09-17）**：主源①②③ + 探针脚本已镜像入 `docs/harness/reviews/`（tracked · 见 [`w7_evidence_provenance_20260917.md`](../harness/reviews/w7_evidence_provenance_20260917.md)）并回填仓内链接（非 S2 `.workbuddy` 直链 = 0）；④ 在仓正常。
...
> ✅ **2026-09-17 已清偿**：正式版落盘 [`docs/harness/reviews/w3_ontology_graph_research_20260917.md`](../harness/reviews/w3_ontology_graph_research_20260917.md)（tracked · 全部证据 tracked 路径+行号实测 · 含 axioms 首次对抗复攻 6 构造 + ONTO-OPEN/F1 两条待批准裁决建议）· 探针 [`scripts/onto-probe.mts`](../../scripts/onto-probe.mts)（`node scripts/onto-probe.mts` → `conforms: false` / exit 2 复跑实证）—— 本 ⚠️ 块所述「尚未入库」状态自此解除（硬约束 14 · EVID-PROV）。
