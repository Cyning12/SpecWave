# invoke · 10-task · 2.2.0 闭环起步 W6 task 起草
...
1. 起草 `docs/tasks/active/task_2_2_closed_loop_w6_host_expansion.md`（三宿主扩展（B1））
...
20-task-audit R1 书面审 → 人签 HG-AUDIT-R1 → 30 派工（`feat(2.2-W6): …` · 禁 git add -A）。
