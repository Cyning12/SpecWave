# invoke · 10-task · 2.2.0 闭环起步 W7 task 起草
...
1. 起草 `docs/tasks/active/task_2_2_closed_loop_w7_hygiene.md`（工程健康小清理（E1+C7））
...
20-task-audit R1 书面审 → 人签 HG-AUDIT-R1 → 30 派工（`feat(2.2-W7): …` · 禁 git add -A）。
