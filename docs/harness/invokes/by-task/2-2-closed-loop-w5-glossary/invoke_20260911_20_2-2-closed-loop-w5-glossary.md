# invoke · 20-task-audit · 2.2.0 闭环起步 W5 task R1 书面审
...
1. 书面审 `docs/tasks/active/task_2_2_closed_loop_w5_glossary.md`（D2 双语 GLOSSARY）：对照 SPEC 核对范围/非范围/验收可断言/failure_paths 沿用/思考轮闭合/依赖行/禁 git add -A
2. 审查文落盘：`docs/harness/reviews/task_2_2_closed_loop_w5_glossary_audit_R1_20260911.md`（结论 pass · 零内容阻塞）
...
维护者 / 00 派 30（`feat(2.2-W5): …` · 禁 git add -A）。