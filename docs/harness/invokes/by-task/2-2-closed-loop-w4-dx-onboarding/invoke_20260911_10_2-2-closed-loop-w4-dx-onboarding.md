# invoke · 10-task · 2.2.0 闭环起步 W4 task 起草
...
1. 起草 `docs/tasks/active/task_2_2_closed_loop_w4_dx_onboarding.md`（上手断档（D1+D3））
...
20-task-audit R1 书面审 → 人签 HG-AUDIT-R1 → 30 派工（`feat(2.2-W4): …` · 禁 git add -A）。
