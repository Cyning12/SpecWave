# invoke · 20-task-audit · 2.2.0 闭环起步 W4 task R1 书面审
...
1. 书面审 `docs/tasks/active/task_2_2_closed_loop_w4_dx_onboarding.md`（D1+D3）：对照 SPEC 核对范围/非范围/验收可断言/failure_paths 沿用/思考轮闭合/依赖行/禁 git add -A
2. 审查文落盘：`docs/harness/reviews/task_2_2_closed_loop_w4_dx_onboarding_audit_R1_20260911.md`（结论 pass · 零内容阻塞）
...
5. W4/W5 互链策略核对：先落地先链 · 后落地补链（与 W5 依赖行镜像一致）
...
维护者 / 00 派 30（`feat(2.2-W4): …` · 禁 git add -A）。