...
| `rename-specgate` | [`rename-specgate/`](./rename-specgate/) | **signed** · W0 DONE · W1/W3 IN_PROGRESS · 目标 `spec-wave@2.1.1` | 产品改名 SpecGate · npm `specgate` · GitHub Rename；规划 [`../roadmap/PLAN_rename_specgate_v1_zh.md`](../roadmap/PLAN_rename_specgate_v1_zh.md) |
