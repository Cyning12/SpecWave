...
| `2_1_2-rename-closeout` | [`2_1_2-rename-closeout/`](./2_1_2-rename-closeout/) | **signed** · W0–W3 DONE · **W4 准备中 / 待人 publish**（`spec-wave@2.1.2` · **未** published） | 改名收口：tag↔npm 溯源 · 切断链式废弃 · 对外身份一致 · init `--yes`；规划 [`../roadmap/PLAN_2_1_2_rename_closeout_v1_zh.md`](../roadmap/PLAN_2_1_2_rename_closeout_v1_zh.md) · 验收草稿 [`../roadmap/ACCEPTANCE_2_1_2_rename_closeout_2_1_2_zh.md`](../roadmap/ACCEPTANCE_2_1_2_rename_closeout_2_1_2_zh.md) |
